...
class ReadingListService extends InterceptorApi {
  ...
  Future<Response> postArticleToReadingList(
      String token, String articleId, String readingListId) async {
    try {
      const String url = Endpoint.baseUrl + Endpoint.postArticleToReadingLists;
